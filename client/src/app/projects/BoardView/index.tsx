...
const BoardView = ({id, setIsModalNewTaskOpen}: BoardProps) => {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
        <div className="grid grid-cols-5 gap-4 p-4 md:grid-cols-2 xl:grid-cols-4">
    ...
    return(
        ...
        >
            <div className="mb-3 flex w-full">
                <div className={`w-2 !bg-[${statusColour[status]}] rounded-s-lg`} style={{backgroundColor: statusColour[status]}}/>
                    <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
                        <h3 className="flex items-center text-lg font-semibold dark:text-white">
                            {status}{" "}                        
                            <span className="ml-2 mb-1 inline-block rounded-full bg-gray-200 p-1 text-center text-sm leading-none dark:bg-dark-tertiary" style={{ width: "1.5rem", height: "1.5rem" }}>
                                {tasksCount}
                            </span>
                        </h3>
    ...
    return(
        ...
        >
            ...
            <div className="p-4 md:p-6">
                ...
                <div className="etxt-xs text-gray-500 dark:text-neutral-500">
