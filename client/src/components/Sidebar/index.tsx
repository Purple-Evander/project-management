...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col h-[100%] justifuy-between shadow-xl
    transition-all duration-300 h-full z-20 dark:bg-black overflow-y-auto bg-white ${isSidebarCollapsed ? "w-0 hidden" : "w-64"}`;
    ...
    <div className={sidebarClassNames}>
        <div className='flex h-[100%] w-full flex-col justify-start'>
            ...
            <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
                ...
                <div className="text-md font-bold tracking-wide dark:text-white">
                    <h3>Purple Team</h3>
...
const SidebarLink= ({
    ...
    return(
        <Link href={href} className="w-ful">
